    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero', models.CharField(blank=True, default='S/N', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peso', models.DecimalField(decimal_places=2, default=3, max_digits=5)),
                ('comprimento', models.DecimalField(decimal_places=2, default=20, max_digits=5)),
                ('altura', models.DecimalField(decimal_places=2, default=20, max_digits=5)),
                ('largura', models.DecimalField(decimal_places=2, default=20, max_digits=5)),
